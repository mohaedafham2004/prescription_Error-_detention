...
export default function AboutPage() {
  const pipelineSteps = [
    ...
    {
      step: "05",
      title: "Multi-Surface Presentation",
      desc: "Real-time Next.js frontend, FastAPI backend REST endpoints, and Streamlit pharmacist dashboard.",
      tech: "FastAPI • Next.js 14 • Tailwind",
