...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-slate-100 dark:bg-[#0B1120] p-1 text-slate-500 dark:text-[#94A3B8] border border-slate-200 dark:border-[#1E2A44]",
      className
    )}
    {...props}
  />
    ...
    return (
      <button
        ...
        className={cn(
          ...
          isActive
            ? "bg-white dark:bg-[#131B2E] text-[#0284C7] dark:text-[#38BDF8] shadow-sm border border-slate-200 dark:border-[#1E2A44]"
            : "hover:bg-slate-200/50 dark:hover:bg-[#1E2A44] hover:text-slate-900 dark:hover:text-white text-slate-600 dark:text-[#94A3B8]",
          className
        )}
